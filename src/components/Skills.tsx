...
const skillGroups = [
  {
    ...
    color: "var(--accent)",
    bg: "var(--accent-muted)",
    skills: ["Python", "Django", "Django REST Framework", "Serializers", "APIView", "GenericAPIView", "Mixins", "ViewSets", "Service Layer Pattern", "Django Signals", "Transaction Management"],
  },
  {
    ...
    skills: ["PostgreSQL", "SQL", "Joins", "Subqueries", "Aggregate Functions", "GROUP BY / HAVING", "Database Normalization", "Concurrency Control"],
  },
  {
    ...
    skills: ["REST APIs", "Custom Authentication", "Nested Serializers", "Cloudinary Integration", "Postman"],
  },
  {
    ...
    skills: ["Penetration Testing", "Bug Bounty Hunting", "OWASP Top 10", "Custom Access-Control Decorators", "Web App Security"],
  },
  {
    ...
    skills: ["JavaScript (ES6+)", "HTML5 & CSS3", "Tailwind CSS", "Responsive Design"],
  },
  {
    ...
    skills: ["Git & GitHub", "Render (Deployment)", "Cloudinary", "psql", "Linux / Bash", "Markdown Documentation"],
  },
];
